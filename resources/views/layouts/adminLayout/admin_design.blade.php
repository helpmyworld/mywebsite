...
<link rel="stylesheet" href="{{ asset('/public/css/backend_css/sweetalert.css') }}" />
<link href="{{ asset('/public/css/backend_css/font-awesome.css') }}" rel="stylesheet" />
...
<script src="{{ asset('/public/js/backend_js/sweetalert.min.js') }}"></script>--}}
