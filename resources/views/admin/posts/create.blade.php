    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
                <a href="#">Posts</a> <a href="#" class="current">Add Post</a> </div>
            <h1>Posts</h1>
                            ...
                            <div class="widget-content nopadding">
                                <form class="form-horizontal"  method="post" action="{{route('posts.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea id="body" name="body" class="form-control message" no validate></textarea>
                                            @if($errors->has('body'))
                                                <span class="help-block">
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success">Make Post</button>
                                    </div>
                                </form>
                            </div>
                        </div>
