        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post"
                  action="{{ url('/admin/add-users') }}" name="add_users" id="add_users" novalidate="novalidate">
              {{ csrf_field() }}
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea name="bio" id="bio" rows="5" class="span8">{{ old('bio') }}</textarea>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <label style="display:inline-block;">
                    <input type="checkbox" name="featured_author" id="featured_author" value="1" {{ old('featured_author') ? 'checked' : '' }}>
                    Featured user
                  </label>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <span class="help-block">Upload User image (JPEG, PNG, GIF)</span>
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <span class="help-block">Select any books already in the products table. You can leave this empty and link later.</span>
                </div>
              </div>
