...
@section('content')
  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Products</a> <a href="#" class="current">View CMS Pages</a> </div>
      <h1>Pages</h1>
                ...
                @foreach($cmsPages as $page)
                  <tr class="gradeX">
                    ...
                    <td class="center">
                      ...
                      <a href="{{ url('/admin/delete-cms-page/'.$page->id) }}" class="btn btn-danger btn-mini deleteRecord">Delete</a>
                      <div id="myModal{{ $page->id }}" class="modal hide">
                        <div class="modal-header">
                          <button data-dismiss="modal" class="close" type="button">×</button>
                          <h3>{{ $page->title }} Full Details</h3> i can
                        </div>
                        <div class="modal-body">
                          <p><strong>Title:</strong> {{ $page->id }}</p>
