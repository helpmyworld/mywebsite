...
@section('content')
    ...
    <!-- begin breadcrumb -->
        ...
        <!-- end #content -->
            <div class="row-fluid">
                <div class="span12">
                    <h1 class="page-header"><a href="{{route('admin.works.create')}}" class="btn btn-dark">Add Website Function <i class="fa fa-plus"></i></a> </h1>
                            ...
                            <table class="table table-bordered data-table">
                                ...
                                @foreach($works as $row)
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <div class="span4">
                                                <a href="{{route('admin.works.edit',['id' => $row->id])}}" class="btn btn-success">
                                                    Edit
                                                </a>
                                            </div>
                                            <div class="span8">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Delete Function</h4>
    ...
    <!-- #modal-without-animation -->
        ...
        <script>
            ...
            $('.trigger-modal').on('click', function () {
                ...
                //set form action
                $('#delete-form').attr('action',"{{url('/admin/works')}}/"+id)
