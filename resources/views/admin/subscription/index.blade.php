...
@section('content')
    ...
    <!-- begin breadcrumb -->
        ...
        <div class="container-fluid"><hr>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <h1 class="page-header"><a href="{{route('admin.subscriptions.create')}}" class="btn btn-dark">Add Subscription <i class="fa fa-plus"></i></a> </h1>
                            ...
                            <table class="table table-bordered data-table">
                                ...
                                @foreach($subscriptions as $row)
                                    <tr class="odd gradeX">
                                        ...
                                        <td>{{$row->title}}</td>
                                        <td>
                                            @foreach($row->benefits()->get() as $benefit)
                                                {{$benefit->name}} ;
                                            @endforeach
                                        </td>
                                        <td>{{$row->price}}</td>
                                        <td>
                                            <div class="span4">
                                                <a href="{{route('admin.subscriptions.edit',['id' => $row->id])}}" class="btn btn-success">
                                                    Edit
                                                </a>
                                            </div>
                                            <div class="span8">
