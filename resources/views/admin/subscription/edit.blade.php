                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal"  method="post" action="{{route('admin.subscriptions.update',['id' => $subscription->id])}}" >
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="title" placeholder="Enter title" class="form-control"  value="{{$subscription->title}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="price" placeholder="200.00" class="form-control"  value="{{$subscription->price}}" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="controls">
                                        <select class="select2-multi"  id="benefit" name="benefits[]"   multiple >
                                            ...
                                            @foreach($benefits as $row)
                                                <option value="{{$row->id}}" {{in_array($row->id,array_values($subscription_benefits)) ? 'selected' : ''}}  >{{$row->name}}</option>
                                            @endforeach
