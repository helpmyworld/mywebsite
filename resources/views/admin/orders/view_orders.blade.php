...
<div id="content">
  ...
  <a href="{{ url('admin/add-manual-order') }}" class="btn btn-primary btn-mini">Add Manual Order</a>
  {{-- Optional admin-wide reports link (you can wire this later) --}}
  {{-- <a href="{{ url('admin/orders-reports') }}" class="btn btn-info btn-mini">Reports</a> --}}
</div>

{{-- Add this inside #content-header, near <h1>Orders</h1> --}}
<div style="margin-top:10px;">
  <a href="{{ route('author.sales.index') }}" class="btn btn-info" target="_blank">Reports</a>
</div>
