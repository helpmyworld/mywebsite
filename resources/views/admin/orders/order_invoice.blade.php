    					...
    					<table class="table table-condensed">
    						...
    						<tbody>
    							...
    							<tr>
    								...
    								<td class="text-center">R {{ $pro->product_price }}</td>
    								<td class="text-center">{{ $pro->product_qty }}</td>
    								<td class="text-right">R {{ $pro->product_price * $pro->product_qty }}</td>
    							</tr>
    							...
    							<tr>
    								...
    								<td class="thick-line text-right">R {{ $Subtotal }}</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-right">R 0</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-right">R {{ $orderDetails->coupon_amount }}</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-right">R {{ $orderDetails->grand_total }}</td>
    							</tr>
    						</tbody>
    					</table>
    				</div>
